...
pos_path = "../data/dataset/plant/resizepos_train/"
neg_path = "../data/dataset/plant/resizeneg_train/"
...
# perform img test
pos_path = "../data/dataset/plant/resizepos_val/"
neg_path = "../data/dataset/plant/resizeneg_val/"
os.system("python ../object-detector/test-imgs.py -p {} -n {}".format(pos_path, neg_path))
